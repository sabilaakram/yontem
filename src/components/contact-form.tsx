...
// import { FormData, sendMessage } from "@/lib/actions"
...
//         <h1 className="text-[32px] leading-[40px]  font-[500] font-gilroy text-white lg:text-[#00051B] md:text-[#00051B] ">Send a Message</h1>
...
//               <FormItem>
//                 <FormControl>
//                   <Input placeholder="Full name" {...field} className="bg-white md:bg-transparent lg:bg-transparent font-gilroy text-[16px] leading-[24px] font-[400] text-[#82869A]"/>
//                 </FormControl>
//                 <FormMessage />
//               </FormItem>
//             )}
...
//               <FormItem>
//                 <FormControl>
//                   <Input placeholder="Email address" type="email" {...field} className="bg-white md:bg-transparent lg:bg-transparent font-gilroy text-[16px] leading-[24px] font-[400] text-[#82869A]" />
//                 </FormControl>
//                 <FormMessage />
//               </FormItem>
//             )}
...
//               <FormItem>
//                 <FormControl>
//                   <Input placeholder="Subject" {...field} className="bg-white md:bg-transparent lg:bg-transparent font-gilroy text-[16px] leading-[24px] font-[400] text-[#82869A]" />
//                 </FormControl>
//                 <FormMessage />
//               </FormItem>
//             )}
...
export function ContactForm() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      const result = await sendMessage(formDataWithToken)
