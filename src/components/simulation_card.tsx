    ...
    style={{
      ...
      backgroundPosition: "center",
        ...
        <div className='md:pl-[50px] md:pr-[20px] md:py-[50px] pl-[20px] pr-[10px] py-[20px] gap-[15px] flex flex-col md:gap-[20px]'>
            ...
            <ParseRichText
              content={Array.isArray(items.text) ? items.text : []} // Replace with actual block content variable
              paragraphProps="font-gilroy text-[#EEE5E5] md:text-[16px] md:leading-[24px] text-[14px] leading-[20px]"
            />
