...
//           alt={baseurl+ product.product_main_image.alternativeText}
//           width={380}
//           height={352}
...
//         >
//           <Link href={`/aviation-products/${product.slug}`}>
...
function AMSProductCard({ product }: Readonly<ProductCardProps>) {
  const baseurl = getStrapiURL();
    ...
    <div className="flex flex-col gap-[30px]">
      ...
      <div className="flex flex-col gap-[20px]">
        ...
        <Button
          ...
          className="px-6 py-3 gap-[10px] bg-[#E31E24] text-[#EEE5E5] rounded-[8px] font-gilroy font-medium text-lg hover:bg-[#515D6A] transition"
        >
          <Link href={`/aviationmaintenancesimulators/${productSlug}`}>
