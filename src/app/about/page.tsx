  ...
  return (
    ...
    <div
      className={`lg:py-[80px] md:py-[70px] py-[50px] flex place-content-center`}>
        ...
        <h2 className="font-gilroy font-[800] text-[28px] md:text-[30px] lg:text-[48px] lg:leading-[60px] md:leading-[36px] leading-[36px]">Driving Excellence: Our Values</h2>
        <p className="list-disc font-gilroy font-[400] text-[16px] md:text-[18px] lg:text-[24px] lg:leading-[36px] md:leading-[28px] leading-[20px]">At the core of Yontem Teknoloji are values that drive our success and innovation:</p>
        <ul className="lg:pl-6 md:pl-4 pl-2 list-disc font-gilroy font-[400] text-[16px] md:text-[18px] lg:text-[24px] lg:leading-[36px] md:leading-[28px] leading-[20px]">
          <li><b>Innovation:</b> We continuously push the boundaries of technology, offering forward-thinking solutions that keep pace with modern advancements.</li>
          <li><b>Quality:</b> Delivering high-quality products and services is key to our approach, ensuring client satisfaction and reliability.</li>
          <li><b>Sustainability:</b> We are committed to contributing positively to society and the environment through sustainable solutions and responsible practices.</li>
        </ul>
        </div>
      </div>
      <Container
